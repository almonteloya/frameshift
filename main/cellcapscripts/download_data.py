...
# adata.obs.head()
#Subset the data based on drugs and cell_lines
...
adata.obs['cell_line_id'] = adata.obs['cell_line_id'].astype(str)
cell_lines = [str(c) for c in cell_lines]
...
adata.write_h5ad("../data/tahoe.h5ad")
